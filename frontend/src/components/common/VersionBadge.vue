  ...
  <div class="relative">
    ...
    <template v-if="isAdmin">
      <button
        ...
        :class="[
          hasUpdate && selfUpdateEnabled
            ? 'bg-amber-100 text-amber-700 hover:bg-amber-200 dark:bg-amber-900/30 dark:text-amber-400 dark:hover:bg-amber-900/50'
            : 'bg-gray-100 text-gray-600 hover:bg-gray-200 dark:bg-dark-800 dark:text-dark-400 dark:hover:bg-dark-700'
        ]"
        :title="
          !selfUpdateEnabled
            ? t('version.customBuildManaged')
            : hasUpdate
      ...
      >
        ...
        ></span>
        <!-- Update indicator -->
        <span v-if="hasUpdate && selfUpdateEnabled" class="relative flex h-2 w-2">
          <span
      ...
      <transition name="dropdown">
        <div
          ...
          :class="rollbackPanelOpen && isReleaseBuild && selfUpdateEnabled ? 'w-80' : 'w-64'"
        >
            ...
            <template v-else>
              ...
              <div class="mb-4 text-center">
                <div class="inline-flex items-center gap-2">
                  ...
                  <span
                    v-if="!hasUpdate || !selfUpdateEnabled"
              ...
              <!-- Priority 1: Custom builds are managed exclusively by the internal release flow. -->
              <div
                v-if="!selfUpdateEnabled"
                class="rounded-lg border border-blue-200 bg-blue-50 p-3 text-xs leading-5 text-blue-700 dark:border-blue-800/50 dark:bg-blue-900/20 dark:text-blue-300"
              >
                {{ t('version.customBuildManaged') }}
              </div>
