...
describe('useAppStore', () => {
  ...
  describe('Version management', () => {
    it('marks custom builds as internally managed with self-update disabled', async () => {
