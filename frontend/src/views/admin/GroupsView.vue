      ...
      >
        ...
        >
          ...
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            >
              <span class="text-sm text-gray-700 dark:text-gray-300">
                {{ t("admin.groups.imagePricing.stripCodexImageGenerationTool") }}
              </span>
              <button
                type="button"
                role="switch"
                data-tour="group-create-strip-image-tool-toggle"
                :aria-label="t('admin.groups.imagePricing.stripCodexImageGenerationTool')"
                :aria-checked="createForm.strip_codex_image_generation_tool"
                @click="
                  createForm.strip_codex_image_generation_tool =
                    !createForm.strip_codex_image_generation_tool
                "
          ...
          <div class="mb-4 grid grid-cols-1 gap-3 md:grid-cols-2">
            ...
            >
              ...
              <button
                type="button"
                role="switch"
                data-tour="group-edit-strip-image-tool-toggle"
                :aria-label="t('admin.groups.imagePricing.stripCodexImageGenerationTool')"
                :aria-checked="editForm.strip_codex_image_generation_tool"
                @click="
                  editForm.strip_codex_image_generation_tool =
                    !editForm.strip_codex_image_generation_tool
                "
                class="relative inline-flex h-6 w-12 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none"
                :class="
...
const closeCreateModal = () => {
  ...
  createForm.strip_codex_image_generation_tool = false;
...
const handleEdit = async (group: AdminGroup) => {
  ...
  editForm.strip_codex_image_generation_tool =
    group.strip_codex_image_generation_tool ?? false;
...
watch(
  ...
  (newVal) => {
    ...
    if (newVal !== "openai") {
      resetMessagesDispatchFormState(editForm);
      editForm.strip_codex_image_generation_tool = false;
    }
    if (!["openai", "antigravity", "anthropic", "gemini"].includes(newVal)) {
