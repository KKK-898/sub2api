...
## NIUBI999 Baseline Note

This directory is the Gaoge v1 production baseline for the customized sub2 service.
`apps/api-core` is the production source of truth, and `workbench/sub2-upstream-sync`
is the internal workspace used to merge official upstream updates before syncing a
tested copy back here. See `../../docs/sub2-upstream-update-flow.md` and
`GAOGE_PATCHES/PATCH_INDEX.md` before changing billing, payment bridge, domain
management, or production database behavior.
