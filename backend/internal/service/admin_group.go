...
func (s *adminServiceImpl) CreateGroup(ctx context.Context, input *CreateGroupInput) (*Group, error) {
	...
	stripCodexImageGenerationTool := input.StripCodexImageGenerationTool && platform == PlatformOpenAI
	...
	group := &Group{
		...
		StripCodexImageGenerationTool:   stripCodexImageGenerationTool,
...
func (s *adminServiceImpl) UpdateGroup(ctx context.Context, id int64, input *UpdateGroupInput) (*Group, error) {
	...
	if input.StripCodexImageGenerationTool != nil {
		group.StripCodexImageGenerationTool = *input.StripCodexImageGenerationTool
	}
	if group.Platform != PlatformOpenAI {
		group.StripCodexImageGenerationTool = false
	}
