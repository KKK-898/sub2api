...
func (h *OpenAIGatewayHandler) Responses(c *gin.Context) {
	...
	imageIntent := service.IsImageGenerationIntentForGroupGate("/v1/responses", reqModel, body, apiKey.Group)
...
func (h *OpenAIGatewayHandler) ResponsesWebSocket(c *gin.Context) {
	...
	if service.IsImageGenerationIntentForGroupGate("/v1/responses", reqModel, firstMessage, apiKey.Group) && !service.GroupAllowsImageGeneration(apiKey.Group) {
