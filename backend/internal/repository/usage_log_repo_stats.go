...
//
// Legacy rows written before attribution existed have an empty action. During
// the migration window we count those rows as subscription usage so the admin
// daily-settlement view does not undercount the current business day.
