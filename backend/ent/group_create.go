...
// SetStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field.
func (_c *GroupCreate) SetStripCodexImageGenerationTool(v bool) *GroupCreate {
	_c.mutation.SetStripCodexImageGenerationTool(v)
	return _c
}

// SetNillableStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field if the given value is not nil.
func (_c *GroupCreate) SetNillableStripCodexImageGenerationTool(v *bool) *GroupCreate {
	if v != nil {
		_c.SetStripCodexImageGenerationTool(*v)
	}
	return _c
}
...
func (_c *GroupCreate) defaults() error {
	...
	if _, ok := _c.mutation.StripCodexImageGenerationTool(); !ok {
		v := group.DefaultStripCodexImageGenerationTool
		_c.mutation.SetStripCodexImageGenerationTool(v)
	}
...
func (_c *GroupCreate) check() error {
	...
	if _, ok := _c.mutation.StripCodexImageGenerationTool(); !ok {
		return &ValidationError{Name: "strip_codex_image_generation_tool", err: errors.New(`ent: missing required field "Group.strip_codex_image_generation_tool"`)}
	}
	if _, ok := _c.mutation.AllowBatchImageGeneration(); !ok {
...
func (_c *GroupCreate) createSpec() (*Group, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.StripCodexImageGenerationTool(); ok {
		_spec.SetField(group.FieldStripCodexImageGenerationTool, field.TypeBool, value)
		_node.StripCodexImageGenerationTool = value
	}
...
// SetStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field.
func (u *GroupUpsert) SetStripCodexImageGenerationTool(v bool) *GroupUpsert {
	u.Set(group.FieldStripCodexImageGenerationTool, v)
	return u
}

// UpdateStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field to the value that was provided on create.
func (u *GroupUpsert) UpdateStripCodexImageGenerationTool() *GroupUpsert {
	u.SetExcluded(group.FieldStripCodexImageGenerationTool)
	return u
}
...
// SetStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field.
func (u *GroupUpsertOne) SetStripCodexImageGenerationTool(v bool) *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.SetStripCodexImageGenerationTool(v)
	})
}

// UpdateStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field to the value that was provided on create.
func (u *GroupUpsertOne) UpdateStripCodexImageGenerationTool() *GroupUpsertOne {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateStripCodexImageGenerationTool()
	})
}
...
// SetStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field.
func (u *GroupUpsertBulk) SetStripCodexImageGenerationTool(v bool) *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.SetStripCodexImageGenerationTool(v)
	})
}
...
// UpdateStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field to the value that was provided on create.
func (u *GroupUpsertBulk) UpdateStripCodexImageGenerationTool() *GroupUpsertBulk {
	return u.Update(func(s *GroupUpsert) {
		s.UpdateStripCodexImageGenerationTool()
	})
}
