...
func (_u *GroupUpdate) SetStripCodexImageGenerationTool(v bool) *GroupUpdate {
	_u.mutation.SetStripCodexImageGenerationTool(v)
	return _u
}

// SetNillableStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field if the given value is not nil.
func (_u *GroupUpdate) SetNillableStripCodexImageGenerationTool(v *bool) *GroupUpdate {
	if v != nil {
		_u.SetStripCodexImageGenerationTool(*v)
	}
	return _u
}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.StripCodexImageGenerationTool(); ok {
...
// SetStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field.
func (_u *GroupUpdateOne) SetStripCodexImageGenerationTool(v bool) *GroupUpdateOne {
	_u.mutation.SetStripCodexImageGenerationTool(v)
	return _u
}

// SetNillableStripCodexImageGenerationTool sets the "strip_codex_image_generation_tool" field if the given value is not nil.
func (_u *GroupUpdateOne) SetNillableStripCodexImageGenerationTool(v *bool) *GroupUpdateOne {
	if v != nil {
		_u.SetStripCodexImageGenerationTool(*v)
	}
	return _u
