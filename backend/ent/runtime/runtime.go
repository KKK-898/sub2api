...
func init() {
	...
	// groupDescStripCodexImageGenerationTool is the schema descriptor for strip_codex_image_generation_tool field.
	groupDescStripCodexImageGenerationTool := groupFields[16].Descriptor()
	// group.DefaultStripCodexImageGenerationTool holds the default value on creation for the strip_codex_image_generation_tool field.
	group.DefaultStripCodexImageGenerationTool = groupDescStripCodexImageGenerationTool.Default.(bool)
