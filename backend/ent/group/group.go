...
const (
	...
	// FieldStripCodexImageGenerationTool holds the string denoting the strip_codex_image_generation_tool field in the database.
	FieldStripCodexImageGenerationTool = "strip_codex_image_generation_tool"
...
var Columns = []string{
	...
	FieldStripCodexImageGenerationTool,
...
var (
	...
	// DefaultStripCodexImageGenerationTool holds the default value on creation for the "strip_codex_image_generation_tool" field.
	DefaultStripCodexImageGenerationTool bool
...
// ByStripCodexImageGenerationTool orders the results by the strip_codex_image_generation_tool field.
func ByStripCodexImageGenerationTool(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldStripCodexImageGenerationTool, opts...).ToFunc()
}
