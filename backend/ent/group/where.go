...
// StripCodexImageGenerationTool applies equality check predicate on the "strip_codex_image_generation_tool" field. It's identical to StripCodexImageGenerationToolEQ.
func StripCodexImageGenerationTool(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldStripCodexImageGenerationTool, v))
}
...
// StripCodexImageGenerationToolEQ applies the EQ predicate on the "strip_codex_image_generation_tool" field.
func StripCodexImageGenerationToolEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldEQ(FieldStripCodexImageGenerationTool, v))
}

// StripCodexImageGenerationToolNEQ applies the NEQ predicate on the "strip_codex_image_generation_tool" field.
func StripCodexImageGenerationToolNEQ(v bool) predicate.Group {
	return predicate.Group(sql.FieldNEQ(FieldStripCodexImageGenerationTool, v))
}
