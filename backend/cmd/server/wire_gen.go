...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	platformSubscriptionUsageCounter := repository.NewPlatformSubscriptionUsageCounter(redisClient)
	platformSubscriptionBillingService := service.ProvidePlatformSubscriptionBillingService(configConfig, platformSubscriptionUsageCounter)
	billingCacheService := service.ProvideBillingCacheService(billingCache, userRepository, userSubscriptionRepository, apiKeyRepository, userRPMCache, userGroupRateRepository, configConfig, serviceUserPlatformQuotaRepository, platformSubscriptionBillingService)
