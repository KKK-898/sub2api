...
- The runtime version remains the pure official baseline, such as `0.1.150`; customization stays in build metadata and the image tag.
...
- Build with the custom Dockerfile and confirm the runtime reports version `0.1.150`.
